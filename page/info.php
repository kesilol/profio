    ...
    <section id="about" class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-100 dark:border-gray-700 mb-8">
        ...
        <div class="space-y-4 text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            <ul class="space-y-2 list-disc list-inside">
                ...
                <li><strong>Для кураторов</strong> — возможность управлять обучающимися и отслеживать их результаты</li>
            </ul>
            ...
            <p>
                ...
                обучающихся, сомневающихся в правильности выбора; взрослых людей, желающих сменить сферу деятельности; 
