...
<main class="overflow-x-scroll scrollbar-hide flex flex-col justify-between pt-[42px] px-[23px] pb-[28px]">
    <div>
        ...
        <div class="flex items-center text-xs text-gray-500 gap-x-[11px] mb-[37px]">
            ...
            <img src="assets/images/icons/icon-arrow-right.svg" alt="Стрелка">
            <span class="capitalize text-color-brands">Управление обучающимися</span>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="rounded-2xl border border-neutral bg-neutral-bg dark:border-dark-neutral-border dark:bg-dark-neutral-bg p-6">
                ...
                <p class="text-gray-500 mb-4">Найдите обучающихся по email и добавьте их в свой список. Каждый обучающийся может быть привязан только к одному куратору.</p>
                ...
                <div class="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <h4 class="font-semibold text-blue-800 mb-2 flex items-center gap-2">
                        ...
                        Доступные обучающиеся для добавления:
                    </h4>
                    <div class="text-sm text-blue-700 space-y-1">
                        ...
                        ?>
                            <div class="text-blue-600">Нет доступных обучающихся</div>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-2xl border border-neutral bg-neutral-bg dark:border-dark-neutral-border dark:bg-dark-neutral-bg p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <span class="text-sm text-gray-500 bg-gray-100 px-2 py-1 rounded">
                        ...
                        echo "{$student_count} обучающихся";
                        ?>
                    </span>
                </div>
                            ...
                            <div class="flex items-center justify-between p-3 border border-neutral dark:border-dark-neutral-border rounded-lg hover:bg-gray-50 dark:hover:bg-gray-dark-50 transition">
                                ...
                                <form method="POST" action="event_user/remove_student.php" class="ml-4">
                                    ...
                                    <button type="submit" class="text-red-500 hover:text-red-700 p-2 rounded hover:bg-red-50 transition" 
                                            onclick="return confirm('Удалить обучающегося <?= htmlspecialchars($student['name']) ?> из списка?')"
                ...
                <?php else: ?>
                    <div class="text-center py-8">
                        ...
                        <p class="text-gray-500">У вас пока нет обучающихся в списке</p>
                        <p class="text-sm text-gray-400 mt-1">Добавьте обучающихся используя форму слева</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
